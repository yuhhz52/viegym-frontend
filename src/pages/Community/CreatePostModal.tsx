      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto" aria-describedby="create-post-description">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Input
              placeholder="VD: Buổi tập chân đầu tiên, Progress sau 3 tháng tập..."
              value={title}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              placeholder="Chia sẻ câu chuyện, kinh nghiệm, tips tập luyện của bạn...&#10;&#10;💡 Gợi ý:&#10;- Thành tích mới đạt được&#10;- Chế độ ăn uống&#10;- Bài tập hiệu quả&#10;- Động lực tập luyện"
              value={content}
          ...
          <div className="p-4 bg-gradient-to-r from-orange-50 to-red-50 dark:from-orange-900/10 dark:to-red-900/10 rounded-lg border-2 border-dashed border-orange-200 dark:border-orange-800">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-semibold text-gray-700 dark:text-gray-300">📸 Thêm ảnh/video</p>
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                  Chia sẻ hình ảnh progress, bài tập hoặc chế độ ăn của bạn
                </p>
              </div>
              <Button
                variant="ghost"
